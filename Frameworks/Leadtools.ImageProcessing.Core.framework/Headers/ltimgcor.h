...
#define AUTOZONE_DETECT_TEXT                        0x00001
#define AUTOZONE_DETECT_GRAPHIC                     0x00002
#define AUTOZONE_DETECT_TABLE                       0x00004
#define AUTOZONE_DETECT_ALL                         0x00007

#define AUTOZONE_DONT_ALLOW_OVERLAP                 0x00000
#define AUTOZONE_ALLOW_OVERLAP                      0x00010
#define AUTOZONE_ACCURATE_ZONES                     0x00000
#define AUTOZONE_GENERAL_ZONES                      0x00100

#define AUTOZONE_DONT_RECOGNIZE_ONE_CELL_TABLE      0x00000
#define AUTOZONE_RECOGNIZE_ONE_CELL_TABLE           0x01000

#if defined (LEADTOOLS_V17_OR_LATER)
#define AUTOZONE_NORMAL_TABLE                       0x00000
#define AUTOZONE_ASIAN_ZONING                       0x00200
#define AUTOZONE_ADVANCED_TABLE                     0x02000
#define AUTOZONE_LINES_RECONSTRUCTION               0x04000
#define AUTOZONE_TEXT_DETECTION                     0x08000
#define AUTOZONE_DETECT_CHECKBOX                    0x10000
#endif // #if defined (LEADTOOLS_V17_OR_LATER)

#if defined (LEADTOOLS_V19_OR_LATER)
#define AUTOZONE_TEXTBOOK                           0x40000
#define AUTOZONE_DETECT_VERTICAL_TEXT               0x100000
#define AUTOZONE_FAVOR_GRAPHICS                     0x400000
...
#if defined (LEADTOOLS_V17_OR_LATER)
#define USE_BLUECHANNEL                    0x0001
#define USE_AUTODOCUMENTBINARIZATION       0x0002
#define USE_DEBLURBINARIZATION             0x0004
#define USE_FASTMODEBINARIZATION           0x0008
#endif // #if defined (LEADTOOLS_V17_OR_LATER)

#define BARCODE_TYPE_UNKNOWN 0x0000
#define BARCODE_TYPE_1D 0x0001
#define BARCODE_TYPE_QR 0x0002
#define BARCODE_TYPE_DATAMATRIX 0x0003
...
#define IMAGE_REGISTRATION_AFFINE12  0x00000006
...
// (05.16.2016 -- Terry(
// I moved these declraations to ltimgcor_.h
// We can bring them back and document them if we want to give this to the customer

//L_LTIMGCOR_API L_INT EXT_FUNCTION L_StartGetMinMaxVal(
//   L_VOID** ppHandle, 
//   pBITMAPHANDLE pBitmap,
//   L_UINT32 uFlags);
//
//L_LTIMGCOR_API L_INT EXT_FUNCTION L_ProcessGetMinMaxVal(
//   L_VOID *pHandle, 
//   L_UCHAR *pScan, 
//   L_UINT *pScanData, 
//   L_UINT uScanDataCount);
//
//L_LTIMGCOR_API L_INT EXT_FUNCTION L_StopGetMinMaxVal(
//   L_VOID *pHandle, 
//   L_INT*pMinVal, 
//   L_INT*pMaxVal);
...
L_LTIMGCOR_API L_INT EXT_FUNCTION L_BrightnessDetection(pBITMAPHANDLE pBitmapOrginal, L_FLOAT* Brightness, L_UINT Flags);
...
L_LTIMGCOR_API L_INT EXT_FUNCTION L_AlignImages(BITMAPHANDLE*pRefBitmap, BITMAPHANDLE* pTempBitmap,  BITMAPHANDLE** ppOutBitmap, L_POINT* RefPoints,  L_POINT* TempPoints, L_INT PointsCount,L_UINT nTransformationMethod);
...
L_LTIMGCOR_API L_INT EXT_FUNCTION L_BlankPageDetectorBitmapExt (pBITMAPHANDLE   pBitmap,
   L_BOOL          *bIsBlank,
   L_UINT          *pAccuracy,
   pPAGEMARGINS    PMargins,
   L_UINT          uSensitivity,
