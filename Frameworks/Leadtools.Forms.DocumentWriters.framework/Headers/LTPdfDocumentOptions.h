...
typedef NS_ENUM(NSInteger, LTPdfDocumentPageModeType) {
    LTPdfDocumentPageModeTypePageOnly,
    LTPdfDocumentPageModeTypeFullScreen,
    LTPdfDocumentPageModeTypeBookmarksAndPage,
    LTPdfDocumentPageModeTypeThumbnailAndPage,
    LTPdfDocumentPageModeTypeLayerAndPage,
    LTPdfDocumentPageModeTypeAttachmentsAndPage
};
