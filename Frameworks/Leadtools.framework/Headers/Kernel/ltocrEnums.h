#ifndef __LTOCR_ENUMS_H__
#define __LTOCR_ENUMS_H__
...
enum L_OcrTextStyle
{
   ...
   L_OcrTextStyle_Header,  // In header section of the the page. Usually smaller font
   L_OcrTextStyle_Footer,  // In footer section of the the page. Usually smaller font
...
enum L_OcrPageBitmapType
{
   ...
   L_OcrPageBitmapType_Processing  // Get the processing image, a copy is returned and its your responsibilty to free it with L_FreeBitmap
};
...
enum L_OcrBitmapSharingMode
{
   ...
   // The page will free the BITMAPHANDLE when it is freed (the page ownes the BITMAPHANDLE)
...
#endif // #ifndef __LTOCR_ENUMS_H__
