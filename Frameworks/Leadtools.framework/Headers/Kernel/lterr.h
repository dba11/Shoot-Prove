...
#define ERROR_LEADTOOLS_LAST_USED   -1783
#define ERROR_LEADTOOLS_NEXT        -1784
...
typedef enum
{
   ...
   ERROR_KERNEL_EXPIRED             = -1591, // Kernel has expired
...
typedef enum
{
   ...
   ERROR_NO_SERVER_LICENSE       = -1752, // Requires a server license
...
typedef enum
{
   ...
   ERROR_SVG_FILTER_MISSING         = -1575, // LTSVG filter is needed to use this function
   ...
   ERROR_JLS_FILTER_MISSING         = -1588, // LFJLS filter is needed to use this function
   ERROR_DCF_FILTER_MISSING         = -1589, // LFDCF filter is needed to use this function
   ERROR_HTM_FILTER_MISSING         = -1595, // LFHTM filter is needed to use this function
   ERROR_MOB_FILTER_MISSING         = -1596, // LFMOB filter is needed to use this function
   ERROR_PUB_FILTER_MISSING         = -1597, // LFPUB filter is needed to use this function
   ERROR_ING_FILTER_MISSING         = -1598, // LFING filter is needed to use this function
   ERROR_PST_FILTER_MISSING         = -1773, // LFPST filter is needed to use this function
   ERROR_XMP_FILTER_MISSING         = -1776, // LFXMP filter is needed to use this function
   ERROR_X9F_FILTER_MISSING         = -1777, // LFX9F filter is needed to use this function
} L_ERROR_MISSING;
...
typedef enum
{
   ...
   ERROR_BARCODE_FOUNDCORRUPT             = -431,  // Bar Code PDF417 symbol is found but cannot read successfully
   ...
   ERROR_BARCODE_AZTEC_READ_LOCKED        = -1370, // Bar Code Read AZTEC is locked
   ERROR_BARCODE_AZTEC_WRITE_LOCKED       = -1371, // Bar Code Write AZTEC is locked
   ERROR_BARCODE_MAXI_READ_LOCKED         = -1372, // Bar Code Read MAXI is locked
   ERROR_BARCODE_MAXI_WRITE_LOCKED        = -1373, // Bar Code Write MAXI is locked
   ERROR_BARCODE_MICROQR_READ_LOCKED      = -1374, // Bar Code Read MICROQR is locked
   ERROR_BARCODE_MICROQR_WRITE_LOCKED     = -1375, // Bar Code Write MICROQR is locked
...
typedef enum
{
   ...
   ERROR_PRNDRV_INSTALL_REGISTRY_ACCESS   = -1626, // Installation Cant Access Registry
