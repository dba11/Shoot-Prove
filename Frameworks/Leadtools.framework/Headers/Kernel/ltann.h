...
typedef struct tagANNENCRYPTOPTIONS
{
   ...
   L_BOOL      bClearEncryptorKey;     // After L_AnnEncryptApply, clear encrytor key 
   L_BOOL      bClearDecryptorKey;     // After L_AnnEncryptApply, clear decrytor key 
