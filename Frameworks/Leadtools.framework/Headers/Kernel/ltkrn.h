...
#define RES_LOWHIGHBITVALID         0x00000002                 // 0x00000002 Destination nLowBit and nHighBit are valid
...
enum L_LEADResourceDirectory
{
   ...
   L_LEADResourceDirectory_Last = L_LEADResourceDirectory_Fonts // Keep this equal to the last enum member
};
...
L_LTKRN_API L_VOID EXT_FUNCTION L_QuitLEADTOOLS(
   ...
   L_LTKRN_API L_INT EXT_FUNCTION L_InitLEADTOOLS();
