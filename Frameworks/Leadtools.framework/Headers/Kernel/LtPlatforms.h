...
#if !defined(FOR_WINRT) && !defined(_MSC_VER)
...
#define SEEK_END    2
#define SEEK_SET    0
#endif // #if !defined(FOR_WINRT) && !defined(_MSC_VER)
...
#  else
#     define UNREFERENCED_PARAMETER(expr) {do { (void)(expr); } while (0);}
#  endif
...
// undefine __declsped for other platforms
...
#if (defined(FOR_XCODE) && !defined(OBJC_BOOL_DEFINED)) || (!defined(FOR_WINDOWS) && !defined(FOR_WINRT) && !defined(FOR_XCODE))
typedef L_BOOL              BOOL;
#endif // #if (defined(FOR_XCODE) && !defined(OBJC_BOOL_DEFINED)) || (!defined(FOR_WINDOWS) && !defined(FOR_WINRT) && !defined(FOR_XCODE))
...
#if !defined(FOR_WINDOWS) && !defined(FOR_WINRT) && !defined(_T)
#define _T(quote) TEXT(quote)

typedef int64_t __time64_t;
#endif // #if !defined(FOR_WINDOWS) && !defined(FOR_WINRT) && !defined(_T)
...
// In WinRT, operating system handles (HANDLE type for File handes). These handles are wrapped into a L_HANDLE
...
#if !defined(FOR_WINDOWS) || defined(FOR_JNI)
EXTERN_C VOID WINAPI L_OnThreadCreated();
EXTERN_C VOID WINAPI L_OnThreadDestroyed();
#endif // #if !defined(FOR_WINDOWS) || defined(FOR_JNI)
...
#if !defined(FOR_WINRT) && !defined(FOR_XCODE)
HANDLE WINAPI GetCurrentThread();
#endif // #if !defined(FOR_WINRT) && !defined(FOR_XCODE)
...
EXTERN_C Windows::UI::Core::CoreDispatcher^ WINAPI L_GetCoreDispatcher();
EXTERN_C int WINAPI L_SetCoreDispatcher();
EXTERN_C L_BOOL WINAPI L_HasThreadAccess();
...
#if defined(LT_COMP_UNICODE)
L_HANDLE WINAPI CreateEventW(LPSECURITY_ATTRIBUTES lpEventAttributes, L_BOOL bManualReset, L_BOOL InitialState, const wchar_t* lpName);
L_HANDLE WINAPI CreateMutexW(LPSECURITY_ATTRIBUTES lpMutexAttributes, L_BOOL bInitialOwner, const wchar_t *lpName);
#endif // #if defined(LT_COMP_UNICODE)
...
#if defined(FOR_WINRT)
EXTERN_C DWORD WINAPI GetCurrentTime();
#endif // #if defined(FOR_WINRT)

#if !defined(FOR_WINRT)
DWORD WINAPI TlsAlloc();
#else
#if !defined(FOR_WINRT_PHONE) && (VER_PRODUCTBUILD_QFE <= 17095)
// New SDK defines TlsAlloc for us
DWORD WINAPI TlsAlloc();
#endif // #if !defined(FOR_WINRT_PHONE) && (VER_PRODUCTBUILD_QFE <= 17095)
#endif // #if !defined(FOR_WINRT)

#if !defined(FOR_WINRT) || defined(FOR_WINRT_PHONE)
#if defined(_MSC_VER)
...
#endif // #if !defined(FOR_WINRT) || defined(FOR_WINRT_PHONE)
...
#if !defined(FOR_WINRT) || defined(FOR_WINRT_PHONE)
EXTERN_C L_HANDLE WINAPI CreateFileMappingA(
  L_HANDLE hFile,
...
#if defined(LT_COMP_UNICODE)
L_HANDLE WINAPI CreateFileMappingW(
  L_HANDLE hFile,
  LPSECURITY_ATTRIBUTES lpAttributes,
  DWORD flProtect,
  DWORD dwMaximumSizeHigh,
...
#if !defined(FOR_WINRT)
// for Codeblocks only
#if (defined(FOR_LINUX) && !defined(__x86_64__))
