...
//  Leadtools Framework
//
//  Copyright (c) 1991-2016 LEAD Technologies, Inc. All rights reserved.
//
...
// NaN/Infinite
#if defined(FOR_WINDOWS) || defined(FOR_WINRT) || defined(_MSC_VER)
...
#endif // #if defined(FOR_IOS) && !defined(FOR_LINUX)
