...
#define FILE_DOC                          342  // Word Doc file format

#define FILE_ANZ                          343  // Analyze format

#define FILE_PPT                          344  // PowerPoint file format
#define FILE_PPT_JPEG                     345  // PowerPoint file format JPEG compressed
#define FILE_PPT_PNG                      346  // PowerPoint file format PNG compressed

#define FILE_JPM                          347  // Jpeg 2000 JPM

#define FILE_VFF                          348  // Sun TAAC Bitmap
#define FILE_PCLXL                        349  // PCL6 vector format

#define FILE_DOCX                         350  // Office 2007 Word
#define FILE_XLSX                         351  // Office 2007 Spreadsheet
#define FILE_PPTX                         352  // Office 2007 Pointpoint

#define FILE_JXR                          353  // JPEG-XR
#define FILE_JXR_GRAY                     354  // JPEG-XR Grayscale
#define FILE_JXR_CMYK                     355  // JPEG-XR CMYK

#define FILE_JLS                          356  // JPEG-LS

#define FILE_JXR_422                      357  // JPEG-XR YUV 4:2:2
#define FILE_JXR_420                      358  // JPEG-XR YUV 4:2:0

#define FILE_DCF_ARW                      359  // SONY
#define FILE_DCF_RAF                      360  // FUJIFILM
#define FILE_DCF_ORF                      361  // OLYMPUS
#define FILE_DCF_CR2                      362  // CANON
#define FILE_DCF_NEF                      363  // NIKON
#define FILE_DCF_RW2                      364  // PANASONIC
#define FILE_DCF_CASIO                    365  // CASIO
#define FILE_DCF_PENTAX                   366  // PENTAX

#define FILE_JLS_LINE                     367  // JPEG-LS interleave mode line
#define FILE_JLS_SAMPLE                   368  // JPEG-LS interleave mode sample

#define FILE_HTM                          369  // HTML

#define FILE_MOB                          370  // Mobi file format

#define FILE_PUB                          371  // ePub file format

#define FILE_ING                          372  // INGR file format (uncompressed)
...
#define FILE_DWFX                         376  // DWFX file format

#define FILE_ICA_JPEG                     377
#define FILE_ICA_JPEG_411                 378
#define FILE_ICA_JPEG_422                 379

#define FILE_DCF_DNG                      380

#define FILE_RAW_FLATE                    381
#define FILE_RAW_RLE                      382

#define FILE_DICOM_JPEG_LS_GRAY           383
#define FILE_DICOM_JPEG_LS_COLOR          384

#define FILE_PST                          385
#define FILE_MSG                          386
#define FILE_EML                          387

#define FILE_RAS_PDF_JPX                  388

#define FILE_DICOM_JPX_GRAY               389
#define FILE_DICOM_JPX_COLOR              390
...
#define FILE_JPEG_CMYK                    391   // JPEG 4:4:4 CMYK
#define FILE_JPEG_CMYK_411                392   // JPEG 4:1:1 CMYK
#define FILE_JPEG_CMYK_422                393   // JPEG 4:2:2 CMYK
#define FILE_TIF_JPEG_CMYK                394   // TIFF JPEG 4:4:4 CMYK
#define FILE_TIF_JPEG_CMYK_411            395   // TIFF JPEG 4:1:1 CMYK
#define FILE_TIF_JPEG_CMYK_422            396   // TIFF JPEG 4:2:2 CMYK
#define FILE_SVGZ                         397   // GZIP compressed SVG
...
#if defined(LTV19_CONFIG) && !defined(FOR_X64)
#define ELO2_USEIFD64                  0x00000002   // (BigTIFF only) Use the 64-bit IFD offset (IFD64)
#endif // #if defined(LTV19_CONFIG) && !defined(FOR_X64)
...
#define PDF_HIDE_FORMFIELDS         0x00200000 // Hide form fields
#define PDF_HIDE_DIGITALSIGNATURES  0x00200000 // Hide digital signatures
...
#if defined(LT_COMP_SVG)
#define L_LOADSVGOPTIONS_NONE                0x00  // the created svg file may have text only (No polydraw text, the file still may have images or shapes)
#define L_LOADSVGOPTIONS_ALLOWPOLYLINETEXT   0x01  // the created svg file may have text represented as polyline or text
...
typedef struct _RASTERPDFINFO
{
   ...
   L_INT XResolution;         // Horizontall resolution of the first image.
...
L_LTFIL_API L_INT EXT_FUNCTION L_GetLoadStatus();
...
#if defined(LEADTOOLS_V19_OR_LATER)
L_LTFIL_API L_INT EXT_FUNCTION L_ExtractXMPMetadata(L_TCHAR *pszSrc,
   L_TCHAR *pszDst);

L_LTFIL_API L_INT EXT_FUNCTION L_SaveXMPMetadata(L_TCHAR *pszXmlSrc,
   L_TCHAR *pszDst);
#endif // #if defined(LEADTOOLS_V19_OR_LATER)
...
#define L_GetFormatFromFileExtension L_GetFormatFromFileExtensionA
...
#if defined(LEADTOOLS_V19_OR_LATER)
L_LTFIL_API L_INT EXT_FUNCTION L_GetEmfHandleFromHtmA(
   L_CHAR* pFileName,
   L_INT nPageNumber,
   pRASTERIZEDOCOPTIONS pRasterizeDocOptions,
   HENHMETAFILE *hEmfHandle);
...
#if defined(LEADTOOLS_V19_OR_LATER)
L_LTFIL_API L_INT EXT_FUNCTION L_GetEmfHandleFromHtm(
   L_TCHAR* pFileName,
   L_INT nPageNumber,
   pRASTERIZEDOCOPTIONS pRasterizeDocOptions,
   HENHMETAFILE *hEmfHandle);
...
#endif // #if defined(LEADTOOLS_V17_OR_LATER)
#if defined(LEADTOOLS_V19_OR_LATER)
#define L_GetEmfHandleFromHtm L_GetEmfHandleFromHtmA
#endif // #if defined(LEADTOOLS_V19_OR_LATER)
