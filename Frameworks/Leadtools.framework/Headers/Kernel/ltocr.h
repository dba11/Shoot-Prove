/*************************************************************
   Ltocr.h - OCR module header file
...
#  if defined(FOR_WINDOWS) || defined(FOR_WINRT) || defined(LEADTOOLS_V19_OR_LATER)
#     define L_OCRDOCUMENTSUPPORTED
#  endif // #if defined(FOR_WINDOWS) || defined(FOR_WINRT) || defined(LEADTOOLS_V19_OR_LATER)
...
// 'dest' must be freed using L_OcrMemory_Free
