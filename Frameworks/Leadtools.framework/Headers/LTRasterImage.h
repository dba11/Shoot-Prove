...
extern NSString* const LTRasterImageChangedNotification_flags LT_DEPRECATED_USENEW(19_0, "LTRasterImageChangedNotificationFlags");
...
extern NSString *const LTRasterImagePagesChangedNotification;
/** @brief NSDictionary key. Value: NSNumber(LTRasterImagePagesChangedAction) */
extern NSString *const LTRasterImagePagesChangedNotificationAction;
/** @brief NSDictionary key. Value: NSNumber(NSUInteger) */
extern NSString *const LTRasterImagePagesChangedNotificationStartIndex;
/** @brief NSDictionary key. Value: NSNumber(NSUInteger) */
extern NSString *const LTRasterImagePagesChangedNotificationCount;

extern NSString *const LTRasterImagePagesChangedNotification_action LT_DEPRECATED_USENEW(19_0, "LTRasterImagePagesChangedNotificationAction");
extern NSString *const LTRasterImagePagesChangedNotification_startIndex LT_DEPRECATED_USENEW(19_0, "LTRasterImagePagesChangedNotificationStartIndex");
extern NSString *const LTRasterImagePagesChangedNotification_count LT_DEPRECATED_USENEW(19_0, "LTRasterImagePagesChangedNotificationCount");

/** @brief The maximum number of overlays allowed in a @p LTRasterImage. */
extern const NSUInteger LTRasterImageMaxOverlays;

extern const unsigned int LTRasterImage_MaxOverlays LT_DEPRECATED_USENEW(19_0, "LTRasterImageMaxOverlays");
 ...
 */
+ (nullable instancetype)coloredImageWithWidth:(NSInteger)width height:(NSInteger)height bitsPerPixel:(NSInteger)bitsPerPixel resolution:(NSInteger)resolution backgroundColor:(nullable LTRasterColor *)backColor error:(NSError **)error;
...
/**
 ...
 @returns The initialized @p LTRasterImage instance.
 */
- (nullable instancetype)initWithUserData:(nullable unsigned char *)data userDataLength:(unsigned long)dataLength flags:(LTRasterMemoryFlags)flags width:(NSInteger)width height:(NSInteger)height bitsPerPixel:(NSInteger)bitsPerPixel order:(LTRasterByteOrder)order viewPerspective:(LTRasterViewPerspective)viewPerspective palette:(nullable NSArray<LTRasterColor *> *)palette error:(NSError **)error;
 ...
 */
- (nullable LTRasterImage *)createThumbnailWithWidth:(NSInteger)width thumbnailHeight:(NSInteger)height bitsPerPixel:(NSInteger)bitsPerPixel viewPerspectiveToUse:(LTRasterViewPerspective)viewPerspective sizeFlags:(LTRasterSizeFlags)sizeFlags error:(NSError ** )error;
...
/**
 @brief Creates a new image from the specified device independent bitmap (DIB) stored in an unmanaged pointer.
...
/** @brief Disables raising the @p onChanged: event. */
- (void)disableEvents;

/** @brief Enables raising the @p onChanged: event. */
- (void)enableEvents;
...
/** 
 ...
 @returns The index of the page that was added.
 */
- (NSInteger)addPage:(LTRasterImage *)page;
 ...
 */
- (void)addPages:(LTRasterImage *)pages startIndex:(NSInteger)start count:(NSInteger)count;
 ...
 */
- (void)removePages:(NSInteger)start count:(NSInteger)count;
...
/**
 ...
 @returns The 1-based index of the newly inserted page.
 */
...
/**
 ...
 @param start The 1-based index of the first page to insert. Use @p index = 0 to insert the new page at the beginning (first).
 @param count The number of pages to insert. Specify -1 to insert all pages.
 @pararm index The 1-based index of the page from @p pages to insert.
 */
- (void)insertPages:(LTRasterImage *)pages from:(NSInteger)start count:(NSInteger)count atIndex:(NSInteger)index;
 ...
 */
- (void)replacePageAtIndex:(NSInteger)index withPage:(LTRasterImage *)page;
 ...
 */
- (void)replacePageAtIndex:(NSInteger)index withPages:(LTRasterImage *)pages start:(NSInteger)start count:(NSInteger)count;
...
/**
 ...
 @returns The number of segments from @p row that are contained in the region.
 */
- (NSUInteger)regionClipSegmentsForRow:(NSInteger)row segmentsBuffer:(unsigned int *)buffer;
...
/**
 ...
 @param xform The @p LTRasterRegionXForm object that LEADTOOLS uses to translate between display coordinates and image coordinates. If you specify nil for this parameter, the scalar fields default to 1, the offets default to 0, and the view perspective defaults to the image view perspective.
 @param rect A @p LeadRect that specifies the region.
 ...
 */
- (BOOL)addRectangleToRegion:(nullable LTRasterRegionXForm *)xform rect:(LeadRect)rect combineMode:(LTRasterRegionCombineMode)combineMode error:(NSError **)error;

/**
 @brief Creates or updates the image region by adding a elliptical region.
 
 @param xform The @p LTRasterRegionXForm object that LEADTOOLS uses to translate between display coordinates and image coordinates. If you specify nil for this parameter, the scalar fields default to 1, the offets default to 0, and the view perspective defaults to the image view perspective.
 @param rect A @p LeadRect that represents the bounding rectangle that defines the ellipse.
 @param combineMode The action to take regarding the existing image region, if one is defined.
 @param error If an error occurs, upon returns contains an NSError object that describes the problem. If you are not interested in possible errors, pass in nil.
 
 @returns YES if the ellipse was set into the region, otherwise NO.
 */
- (BOOL)addEllipseToRegion:(nullable LTRasterRegionXForm *)xform rect:(LeadRect)rect combineMode:(LTRasterRegionCombineMode)combineMode error:(NSError **)error;
 ...
 */
- (BOOL)addPolygonToRegion:(nullable LTRasterRegionXForm *)xform points:(LeadPoint *)points length:(NSInteger)length fillMode:(LTLeadFillMode)fillMode combineMode:(LTRasterRegionCombineMode)combineMode error:(NSError **)error;
...
/**
 ...
 @returns YES if the polygon was set into the region, otherwise NO.
 */
- (BOOL)addColorRgbRangeToRegion:(LTRasterColor *)lowerColor upperColor:(LTRasterColor *)upperColor combineMode:(LTRasterRegionCombineMode)combineMode error:(NSError **)error;
...
/**
 ...
 @returns YES if the polygon was set into the region, otherwise NO.
 */
- (BOOL)addColorHsvRangeToRegion:(LTRasterHsvColor *)lowerColor upperColor:(LTRasterHsvColor*)upperColor combineMode:(LTRasterRegionCombineMode)combineMode error:(NSError **)error;
...
/**
 ...
 @returns YES if the polygon was set into the region, otherwise NO.
 */
- (BOOL)addColorToRegion:(LTRasterColor *)color combineMode:(LTRasterRegionCombineMode)combineMode error:(NSError **)error;
 ...
 */
- (BOOL)addMaskToRegion:(nullable LTRasterRegionXForm *)xform maskImage:(LTRasterImage *)mask combineMode:(LTRasterRegionCombineMode)combineMode error:(NSError **)error;
 ...
 */
- (BOOL)addMagicWandToRegion:(NSInteger)left top:(NSInteger)top lowerToleranceColor:(LTRasterColor *)lowTolColor upperToleranceColor:(LTRasterColor *)upTolColor combineMode:(LTRasterRegionCombineMode)combineMode error:(NSError **)error;
 ...
 */
- (BOOL)addBorderToRegion:(NSInteger)left top:(NSInteger)top borderColor:(LTRasterColor *)borderColor lowerToleranceColor:(LTRasterColor *)lowTolColor upperToleranceColor:(LTRasterColor *)upTolColor combineMode:(LTRasterRegionCombineMode)combineMode error:(NSError **)error;
 ...
 */
- (NSInteger)getRow:(NSInteger)row buffer:(unsigned char *)buffer bufferCount:(unsigned long)count error:(NSError **)error;
 ...
 */
- (NSInteger)setRow:(NSInteger)row buffer:(const unsigned char *)buffer bufferCount:(unsigned long)count error:(NSError **)error;
...
/**
 ...
 @returns The number of bytes copied.
 */
- (NSInteger)getRowColumn:(NSInteger)row column:(NSInteger)column buffer:(unsigned char *)buffer bufferCount:(unsigned long)count error:(NSError **)error;
 ...
 */
- (NSInteger)setRowColumn:(NSInteger)row column:(NSInteger)column buffer:(const unsigned char *)buffer bufferCount:(unsigned long)count error:(NSError **)error;


/** @brief For internal use by LEADTOOLS. */
- (BOOL)setRowSegments:(NSInteger)row column:(NSInteger)column buffer:(const unsigned char *)buffer segments:(const unsigned int *)segments segmentCount:(unsigned int)count preserveAlpha:(BOOL)preserveAlpha error:(NSError **)error;
...
/**
 ...
 @returns YES if the row was retrieved, otherwise NO.
 */
- (BOOL)getRowCompressed:(unsigned char *)workBuffer runBuffer:(unsigned short *)runBuffer row:(NSUInteger)row lines:(NSUInteger)lines error:(NSError **)error;
 ...
 */
- (NSInteger)getRowColumnCompressed:(unsigned char *)workBuffer runBuffer:(unsigned short *)runBuffer row:(NSInteger)row column:(NSInteger)column width:(NSUInteger)pixels error:(NSError **)error;
...
/**
 ...
 @returns The number of pixels processed.
 */
- (NSInteger)setRowColumnCompressed:(unsigned char *)workBuffer runBuffer:(const unsigned short *)runBuffer row:(NSInteger)row column:(NSInteger)column width:(NSUInteger)pixels error:(NSError **)error;
 ...
 */
- (LTRasterColor *)getPixelColorAtRow:(NSInteger)row column:(NSInteger)column;
 ...
 */
- (LTRasterColor *)getPixelAtRow:(NSInteger)row column:(NSInteger)column;
 ...
 */
- (BOOL)setColor:(LTRasterColor *)color forPixelAtRow:(NSInteger)row column:(NSInteger)column error:(NSError **)error;
...
/**
 ...
 @returns YES if the pixel was set, otherwise NO.
 */
- (BOOL)setPixel:(LTRasterColor *)color atRow:(NSInteger)row column:(NSInteger)column error:(NSError **)error;
 ...
 */
- (BOOL)getData:(void *)data ofSize:(unsigned long)size forPixelAtRow:(NSInteger)row column:(NSInteger)column error:(NSError **)error;
...
/**
 ...
 @returns YES if the data was set, otherwise NO.
 */
- (BOOL)setData:(const void *)data ofSize:(unsigned long)size forPixelAtRow:(NSInteger)row column:(NSInteger)column error:(NSError **)error;
...
/**
 ...
 @returns YES if the data was set, otherwise NO.
 */
- (BOOL)setUserData:(nullable unsigned char *)userData userDataSize:(unsigned long)userDataSize error:(NSError **)error;
 ...
 */
- (LeadPoint)pointFromImage:(LTRasterViewPerspective)viewPerspective sourcePoint:(LeadPoint)src;
 ...
 */
- (LeadRect)rectangleFromImage:(LTRasterViewPerspective)viewPerspective sourceRect:(LeadRect)src;
 ...
 */
- (BOOL)ditherLine:(const unsigned char *)srcBuffer destBuffer:(unsigned char *)dstBuffer error:(NSError **)error;
 ...
 */
- (BOOL)windowLevel:(NSInteger)lowBitValue highBit:(NSInteger)highBitValue palette:(nullable NSArray<LTRasterColor *> *)palette mode:(LTRasterWindowLevelMode)mode error:(NSError **)error;
...
/**
 ...
 @returns YES if the options were set, otherwise NO.
 */
- (BOOL)windowLevelExt:(NSInteger)lowBitValue highBit:(NSInteger)highBitValue palette:(nullable NSArray<LTRasterColor16 *> *)palette mode:(LTRasterWindowLevelMode)mode error:(NSError **)error;
 ...
 */
+ (LeadRect)calculatePaintModeRectangle:(NSInteger)sourceWidth sourceHeight:(NSInteger)sourceHeight destinationRectangle:(LeadRect)dstRect sizeMode:(LTRasterPaintSizeMode)sizeMode horizontalAlignMode:(LTRasterPaintAlignMode)horizontalAlignMode verticalAlignMode:(LTRasterPaintAlignMode)verticalAlignMode;
 ...
 */
- (BOOL)setOverlay:(nullable LTRasterImage *)overlayImage forImageAtIndex:(NSInteger)index mode:(LTRasterGetSetOverlayImageMode)mode error:(NSError **)error;
...
/**
 ...
 @returns YES if the overlay is set, otherwise NO.
 */
- (BOOL)setOverlaySize:(LeadSize)size forImageAtIndex:(NSInteger)index error:(NSError **)error;
 ...
 */
- (BOOL)updateOverlayBitFlags:(LTRasterUpdateOverlayBitsFlags)flags forImageAtIndex:(NSInteger)index error:(NSError **)error;
 ...
 */
- (BOOL)updateOverlayAttributes:(LTRasterOverlayAttributes *)attributes atIndex:(NSInteger)index flags:(LTRasterGetSetOverlayAttributesFlags)flags error:(NSError **)error;
 ...
 */
- (BOOL)underlay:(LTRasterImage *)underlayImage flags:(LTRasterImageUnderlayFlags)flags error:(NSError **)error;
