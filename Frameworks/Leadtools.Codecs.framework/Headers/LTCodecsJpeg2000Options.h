...
- (void)getHorizontalSubSamplingValues:(NSUInteger[_Nullable LTCodecsJpeg2000MaximumComponentsNumber])values;
- (void)setHorizontalSubSamplingValues:(const NSUInteger[_Nullable LTCodecsJpeg2000MaximumComponentsNumber])values;
- (void)getVerticalSubSamplingValues:(NSUInteger[_Nullable LTCodecsJpeg2000MaximumComponentsNumber])values;
- (void)setVerticalSubSamplingValues:(const NSUInteger[_Nullable LTCodecsJpeg2000MaximumComponentsNumber])values;
