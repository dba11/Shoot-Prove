...
@class Eula;
@protocol RegisterTermsViewControllerDelegate <NSObject>
@optional
- (void)didRegisterTermsViewControllerRequestCancel;
@required
- (void)didRegisterTermsViewControllerReturnEula:(Eula *)eula;
@end
@interface RegisterTermsViewController : UIViewController <UIWebViewDelegate, DialogDelegate>
